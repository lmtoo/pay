...
/**
 * 公共MD5工具类(兼容百度钱包，首信，连连等)
 */
public class MD5Util {

    protected static Log logger = LogFactory.getLog(MD5Util.class);
     ...
     *
     * @param res
     * @param encoding 如果未空走，项目默认编码
     * @return
     */
    public final static String md5DigestLow32(String res, String encoding) {
     ...
     * @throws java.io.IOException Thrown if the digestifier was unable to read the
     *                             input stream.
     */
    ...
    public static String sign(String content, String key, String input_charset) {
        ...
        try {
            return DigestUtils.md5Hex(getContentBytes(tosign, input_charset));
        } catch (Exception e) {
            logger.error("md5 sign error,e:"+e);
        }
        return "";
    }
    ...
    public static boolean verify(String content, String sign, String key, String input_charset) {
        ...
        String tosign = (content == null ? "" : content) + key;
        try {
            String mySign = DigestUtils.md5Hex(getContentBytes(tosign, input_charset));
            if (mySign.equals(sign)) {
                return true;
            }
        } catch (Exception e) {
            logger.error("md5 verify error,e:"+e);
        }
        return flag;
    }
    ...
    private static byte[] getContentBytes(String content, String charset) {
        ...
        try {
            ...
            logger.error("md5 getContentBytes error,e:"+e);
        }
        return null;
    }
